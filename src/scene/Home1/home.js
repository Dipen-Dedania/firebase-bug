    ...
    componentWillMount() {
        IsUserLoggedIn(false, function (user) {
            if (user != null) {
                ...
                div.innerHTML = "<h2>Demopage2</h2><br>" + "Username :" + user.displayName + "<br>Email :" + user.email;
                ...
                <div className="mainDiv">
                    <div id="contentDiv">
                        ...
                        <div className="text-center">
                            <RaisedButton label="Logout" backgroundColor="#FFF" labelColor="#000" onClick={this.logOut}
                                           secondary={true}/>
                        </div>
                    </div>
                </div>
